...
(function () {
    ...
    function initDrawer() {
        ...
        const exportSaveBtn = document.getElementById('reader-export-save-btn');
        if (exportSaveBtn) {
        ...
        const importSaveInput = document.getElementById('reader-import-save-input');
        if (importSaveInput) {
    ...
    function exportSaveData() {
        const payload = getSaveDataSnapshot();
    ...
    function restoreSaveData(parsed) {
    ...
    function importSaveData(file) {
        ...
        reader.onload = (e) => {
            try {
                ...
                const count = restoreSaveData(parsed);
